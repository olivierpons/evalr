...
class WizardStepNewExamStep2(WizardBase):
    ...
    def set_prev_step(self, new_step, request, data, **kwargs):
        ...
        return True, WzUserStep.WZ_STEP_NEW_EXAM_TEMPLATE_STEP_1, \
    ...
    def set_next_step(self, new_step, request, data, **kwargs):
        ...
        from wizard.models.wz_user_step import WzUserStep
        return True, WzUserStep.WZ_STEP_NEW_EXAM_TEMPLATE_STEP_3, \
            str(_("Step 2 done")), db_data, {'success': True, }
